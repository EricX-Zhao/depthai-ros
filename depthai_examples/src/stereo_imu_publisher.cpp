...
std::tuple<dai::Pipeline, int, int> createPipeline(
    bool withDepth, bool lrcheck, bool extended, bool subpixel, bool rectify, int confidence, int LRchecktresh, std::string resolution) {
...
int main(int argc, char** argv) {
    ...
    std::tie(pipeline, monoWidth, monoHeight) = createPipeline(enableDepth, lrcheck, extended, subpixel, rectify, confidence, LRchecktresh, monoResolution);
