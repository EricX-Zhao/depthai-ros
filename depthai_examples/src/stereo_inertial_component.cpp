...
class OAKStereoImu : public rclcpp::Node
{
public:
    OAKStereoImu(const rclcpp::NodeOptions& option) : Node("stereo_inertial_node", option)
    {
        declare_parameter("mxId", "");
        declare_parameter("usb2Mode", false);
        declare_parameter("poeMode", false);
        declare_parameter("resourceBaseFolder", "");
    
        declare_parameter("tf_prefix", "oak");
        declare_parameter("mode", "depth");
        declare_parameter("imuMode", 1);
    
        declare_parameter("lrcheck", true);
        declare_parameter("extended", false);
        declare_parameter("subpixel", true);
        declare_parameter("rectify", false);
    
        declare_parameter("depth_aligned", true);
        declare_parameter("stereo_fps", 30);
        declare_parameter("confidence", 200);
        declare_parameter("LRchecktresh", 5);
        declare_parameter("monoResolution", "720p");
        declare_parameter("rgbResolution", "1080p");
        declare_parameter("manualExposure", false);
        declare_parameter("expTime", 20000);
        declare_parameter("sensIso", 800);
    
        declare_parameter("rgbScaleNumerator", 2);
        declare_parameter("rgbScaleDinominator", 3);
        declare_parameter("previewWidth", 416);
        declare_parameter("previewHeight", 416);
    
        declare_parameter("angularVelCovariance", 0.02);
        declare_parameter("linearAccelCovariance", 0.0);
        declare_parameter("enableSpatialDetection", true);
        declare_parameter("detectionClassesCount", 80);
        declare_parameter("syncNN", true);
        declare_parameter("nnName", "x");
    
        declare_parameter("enableDotProjector", false);
        declare_parameter("enableFloodLight", false);
        declare_parameter("dotProjectorIntensity", 0.5);
        declare_parameter("floodLightIntensity", 0.5);
        declare_parameter("enableRosBaseTimeUpdate", false);
    
        // updating parameters if defined in launch file.
    
        get_parameter("mxId", mxId);
        get_parameter("usb2Mode", usb2Mode);
        get_parameter("poeMode", poeMode);
        get_parameter("resourceBaseFolder", resourceBaseFolder);
    
        get_parameter("tf_prefix", tfPrefix);
        get_parameter("mode", mode);
        get_parameter("imuMode", imuModeParam);
    
        get_parameter("lrcheck", lrcheck);
        get_parameter("extended", extended);
        get_parameter("subpixel", subpixel);
        get_parameter("rectify", rectify);
    
        get_parameter("depth_aligned", depth_aligned);
        get_parameter("stereo_fps", stereo_fps);
        get_parameter("confidence", confidence);
        get_parameter("LRchecktresh", LRchecktresh);
        get_parameter("monoResolution", monoResolution);
        get_parameter("rgbResolution", rgbResolution);
        get_parameter("manualExposure", manualExposure);
        get_parameter("expTime", expTime);
        get_parameter("sensIso", sensIso);
    
        get_parameter("rgbScaleNumerator", rgbScaleNumerator);
        get_parameter("rgbScaleDinominator", rgbScaleDinominator);
        get_parameter("previewWidth", previewWidth);
        get_parameter("previewHeight", previewHeight);
    
        get_parameter("angularVelCovariance", angularVelCovariance);
        get_parameter("linearAccelCovariance", linearAccelCovariance);
        get_parameter("enableSpatialDetection", enableSpatialDetection);
        get_parameter("detectionClassesCount", detectionClassesCount);
        get_parameter("syncNN", syncNN);
    
        get_parameter("enableDotProjector", enableDotProjector);
        get_parameter("enableFloodLight", enableFloodLight);
        get_parameter("dotProjectorIntensity", dotProjectorIntensity);
        get_parameter("floodLightIntensity", floodLightIntensity);
        get_parameter("enableRosBaseTimeUpdate", enableRosBaseTimeUpdate);
        ...
        std::string nnParam;
        get_parameter("nnName", nnParam);
        if(nnParam != "x") {
            get_parameter("nnName", nnName);
        }
        ...
        init_timer_ = create_wall_timer(
            ...
            std::bind(&OAKStereoImu::post_init, this));
    }
    ...
    void post_init()
    {
        std::cout<<"Init OAK Pipeline"<<std::endl;
        init_timer_->cancel();
...
RCLCPP_COMPONENTS_REGISTER_NODE(OAKStereoImu)